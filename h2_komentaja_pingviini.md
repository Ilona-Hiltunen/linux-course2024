...
Seuraavaksi tein saman komennon pääkäyttäjänä lisäämällä sudo äskeisen komennon eteen. Terminaali kysyi käyttäjän salasanaani, jonka jälkeen se alkoi etsiä uusia paketteja. Tällä tavalla haluttu pakettilistan päivitys onnistui. Kuten seuraavasta kuvasta näkee, löytyi pakettilistaan neljä uudempaa versiota. Kaikki päivitykset olivat Debian-käyttöjärjestelmään.
